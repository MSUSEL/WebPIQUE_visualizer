...
var require_arc = __commonJS({
  "node_modules/react-gauge-component/dist/lib/GaugeComponent/hooks/arc.js"(exports) {
    ...
    var d3_1 = (init_src(), __toCommonJS(src_exports));
...
var require_labels = __commonJS({
  "node_modules/react-gauge-component/dist/lib/GaugeComponent/hooks/labels.js"(exports) {
    ...
    var constants_1 = __importDefault(require_constants());
    var Tick_1 = require_Tick();
    var d3 = __importStar((init_src(), __toCommonJS(src_exports)));
    var GaugeComponentProps_1 = require_GaugeComponentProps();
    var arc_1 = require_arc();
    ...
    var addValueText = function(gauge) {
      ...
      if (gauge.props.type == GaugeComponentProps_1.GaugeType.Semicircle) {
        ...
        y = gauge.dimensions.current.outerRadius * 1 + textPadding;
      }
  ...
  "node_modules/react-gauge-component/dist/lib/GaugeComponent/hooks/pointer.js"(exports) {
    ...
    var setPointerPosition = function(pointerRadius, progress, gauge) {
      ...
      var pointers = (_a = {}, _a[Pointer_1.PointerType.Needle] = function() {
        ...
        var _a2 = (0, arc_1.getCoordByValue)(value, gauge, "inner", 0, 0.7), x = _a2.x, y = _a2.y;
        x -= 1;
        y += pointerRadius - 3;
        (0, exports.translatePointer)(x, y, gauge);
      }, _a[Pointer_1.PointerType.Blob] = function() {
        var _a2 = (0, arc_1.getCoordByValue)(value, gauge, "between", 0, 0.75), x = _a2.x, y = _a2.y;
        x -= 1;
        y += pointerRadius;
        (0, exports.translatePointer)(x, y, gauge);
      }, _a);
...
var require_chart = __commonJS({
  "node_modules/react-gauge-component/dist/lib/GaugeComponent/hooks/chart.js"(exports) {
    ...
    var utilHooks = __importStar(require_utils());
  ...
  "node_modules/react-gauge-component/dist/lib/GaugeComponent/index.js"(exports) {
    ...
    var GaugeComponent = function(props) {
      ...
      var updateMergedProps = function() {
        ...
        if (((_a2 = gauge.props.arc) === null || _a2 === void 0 ? void 0 : _a2.width) == ((_b2 = GaugeComponentProps_1.defaultGaugeProps.arc) === null || _b2 === void 0 ? void 0 : _b2.width)) {
      ...
      (0, react_1.useEffect)(function() {
        ...
        var observer = new MutationObserver(function() {
          var _a3;
          if (!((_a3 = selectedRef.current) === null || _a3 === void 0 ? void 0 : _a3.offsetParent))
            return;
          chartHooks.renderChart(gauge, true);
          observer.disconnect();
        });
        observer.observe((_a2 = selectedRef.current) === null || _a2 === void 0 ? void 0 : _a2.parentNode, { attributes: true, subtree: false });
        return function() {
      ...
      return react_1.default.createElement("div", { id, className: "".concat(gauge.props.type, "-gauge").concat(className ? " " + className : ""), style, ref: function(svg2) {
        return selectedRef.current = svg2;
      } });
    };
